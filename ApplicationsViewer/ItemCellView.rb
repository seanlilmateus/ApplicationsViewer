...
class ItemCellView < NSTableCellView
  ...
  def layoutViewsForLargeSize large_size, animated:animated
    ...
    icon_frame = large_size ? NSMakeRect(2.0, 2.0, icon_size, icon_size) : NSMakeRect(2.0, 15.0, icon_size, icon_size)
		
    name_left = icon_frame.origin.x + icon_frame.size.width + 10.0
    name_bottom = icon_frame.origin.y + icon_frame.size.height - (large_size ? 14.0 : 15.0)
